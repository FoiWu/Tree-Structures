//Generate 11 numbers or alphabets by random or input.

var randomArray = new Array(50);     //Numbers of 1~50.
var dataArray = new Array(8);      //Selected numbers.
...
var generateNumbers = function(){
	...
	　　	　　	randomArray[k]=randomArray[49];
		...
		//
		//page = 1:"xxx_Simulation(Insert).html".
		if( page == 1 ){
		...
		//page = 2:"XXX_Test(BuildATree).html".
		else if( page == 2 ){
			document.getElementById("rawData").innerHTML = dataArray.toString();
		}
	}
